...
const (
	Factorial_Calculate_FullMethodName = "/proto.Factorial/Calculate"
)
...
func (c *factorialClient) Calculate(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (Factorial_CalculateClient, error) {
	stream, err := c.cc.NewStream(ctx, &Factorial_ServiceDesc.Streams[0], Factorial_Calculate_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
